            ...
            <div class="container">
              ...
              <div class="row">
                    <div class="col-lg-4"></div>
                      <div class="col-lg-4">
                        <div class="btn-group">
                          <button type="button" onclick="location.href='/add-item.php';" class="btn btn-primary btn-md btn-success  sell-item-button">Sell Item <img class="menu-picture" src="/imgs/add-item.png"></img> </button>
    ...
    <div class="container">
      ...
      <div class="row">
        ...
        <div class="col-lg-6" style="margin:30px 0px">
            <form action="request-item-function.php" method="POST" >
                
                <div class="alert alert-info">
                  <strong>Write The name of the product you wish to buy</strong> And We will send you a notitication whenever someone provides it .
                </div>

              <div class="form-group">
                <label for="email">Product Name :</label>
                <input name="item" type="text" class="form-control" id="email">
              </div>
              

              
              
              <button type="submit" class="btn btn-default">Request item</button>
            </form>
        </div>
